...
import org.deeplearning4j.examples.misc.activationfunctions.SobelFilter;
 ...
 */
public class LenetMnistSobelExample {
    private static final Logger log = LoggerFactory.getLogger(LenetMnistSobelExample.class);
...
//                .lrPolicyPower(0.75)
                ...
                .layer(3, new SubsamplingLayer.Builder(SubsamplingLayer.PoolingType.MAX)
                        ...
                        .stride(2,2)
                        .build())
                .layer(4, new DenseLayer.Builder().activation(new SobelFilter())
                        .nOut(500).build())
