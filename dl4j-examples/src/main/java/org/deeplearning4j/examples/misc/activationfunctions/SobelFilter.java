 ...
 * @author susaneraly
 */
public class SobelFilter extends BaseActivationFunction{
    ...
    public INDArray getActivation(INDArray in, boolean training) {
        ...
        // h(x) = 1.7159*tanh(2x/3)
        INDArray sobelFilter = Nd4j.zeros(3, 3);

        DataBuffer dB = new IntBuffer(sobelMatrix);
        sobelFilter.setData(dB);
//        sobelFilter.setShape(3,3);
...
//        in.muli(1.7159);
    ...
    public Pair<INDArray,INDArray> backprop(INDArray in, INDArray epsilon) {
        ...
        INDArray sobelFilter = new NDArray();
        sobelFilter.setShape(3,3);
        DataBuffer dB = new IntBuffer(sobelMatrix);
        sobelFilter.setData(dB);
